package de.cdelmonte.zuulsvr.utils;
...
public class UserContextFilter implements Filter {
  ...
  public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
    ...
    logger.debug("Special Routes Service Incoming User id: {}",
        UserContextHolder.getContext().getUserId());
    logger.debug("Special Routes Service Incoming AuthToken: {}",
